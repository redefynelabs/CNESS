        ...
        <div className="flex flex-col lg:flex-row w-full justify-between bg-primary relative">
            ...
            >
                ...
                <div className="space-y-6 w-full max-w-lg">
                    <h1
                        className="text-light font-[450] text-3xl md:text-5xl"
                    ...
                    >
                        ...
                        <motion.button
                            type="submit"
                            className="relative bg-secondary group text-primary px-4 py-2 rounded-full flex font-[450] items-center justify-center gap-3 cursor-pointer overflow-hidden"
