  ...
  return (
    <div className="w-full min-h-screen bg-active px-4 sm:px-6 md:px-10 py-10 md:py-20 text-foreground">
      <div className="flex flex-col md:flex-row w-full items-start md:items-end justify-between mb-10 md:mb-16 space-y-4">
        ...
        >
          <p className="text-xs sm:text-sm font-[450] uppercase border border-primary px-4 py-1 rounded-full">
            {badgeText}
          </p>
          <h1
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-[450]">
          ...
          >
            ...
            {card.title && (
              <div className="py-4 space-y-4">
                <h1 className="text-lg sm:text-xl md:text-2xl font-[450]">{card.title}</h1>
              </div>
            )}
